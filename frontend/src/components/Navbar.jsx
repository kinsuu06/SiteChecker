  ...
  return (
    <nav className="bg-white shadow-lg py-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link
          to="/"
          className="text-3xl font-bold text-gray-800 hover:text-purple-600 transition duration-300"
        >
          SiteChecker Pro
        </Link>
        ...
        <div className="flex space-x-6 items-center">
          ...
          <Link
            to="/feature"
            className={`text-gray-700 hover:text-purple-600 transition duration-300 ${
              activeLink === '/pricing' ? 'text-purple-600 font-bold' : ''
            }`}
          >
            Features
          </Link>
          <Link
            to="/contact"
            className={`text-gray-700 hover:text-purple-600 transition duration-300 ${
              activeLink === '/contact' ? 'text-purple-600 font-bold' : ''
            }`}
          >
            Contact
          </Link>
